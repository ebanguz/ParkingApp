...
public class ListaPanel extends JPanel implements Vehiculo {
	...
	public void initComponets() {
		...
		table.setModel(new DefaultTableModel(new Object[][] {}, new String[] { "Id", "Placa", "Propietario", "E-mail",
				"Tipo de Vehiculo", "Hora Entrada", "Hora Salia", "Pago" }) {
		...
		btnBuscar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					Logger.getLogger(ListaPanel.class.getName()).log(Level.SEVERE, null, ex);
